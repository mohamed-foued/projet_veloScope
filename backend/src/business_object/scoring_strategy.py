...
class ScoringStrategy :
    ...
    @classmethod
    def update_player_ratings(game : Game):
        ...
        if  game.winner.id == game.player1.id:
            up1+=0.5
        if  game.winner.id == game.player2.id:
            up2+=0.5

        game.player1.elo,game.player2.elo= ScoringStrategy.calculate_new_ratings(game.player1.elo,game.player2.elo,up1,up2)
